...
# -*- coding: utf-8 -*-
#
# Restaurant Billing System documentation build configuration file, created by
# sphinx-quickstart on Mon Feb 15 20:22:58 2016.
#
...
htmlhelp_basename = 'RestaurantBillingSystemdoc'
...
latex_documents = [
  (master_doc, 'RestaurantBillingSystem.tex', 'Restaurant Billing System Documentation',
   'Team Aardvark', 'manual'),
]
...
man_pages = [
    (master_doc, 'restaurantbillingsystem', 'Restaurant Billing System Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RestaurantBillingSystem', 'Restaurant Billing System Documentation',
   author, 'RestaurantBillingSystem', 'One line description of project.',
   'Miscellaneous'),
]
